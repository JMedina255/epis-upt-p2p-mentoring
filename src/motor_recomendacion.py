...
def cargar_reglas_sistema() -> Dict[str, Any]:
    """Carga los parámetros del algoritmo desde la fuente única de verdad (system_rules.json).
    ...
    Returns:
        Dict[str, Any]: Diccionario con parámetros globales y pesos del modelo.
    """
    rutas = [
        "system_rules.json",
